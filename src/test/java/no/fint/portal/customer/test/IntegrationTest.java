...
public class IntegrationTest {
  ...
  public void assets() throws Exception {
    ...
    mockMvc.perform(put("/api/assets/testing/test_test_no/adapters/testadapter")).andExpect(status().is(204));
    ...
    mockMvc.perform(put("/api/assets/testing/test_test_no/clients/testclient")).andExpect(status().is(204));
    ...
    mockMvc.perform(delete("/api/assets/testing/test_test_no/clients/testclient")).andExpect(status().is(204));
