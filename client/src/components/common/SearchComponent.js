...
class Search extends Component {
  ...
  renderSelectedItems() {
	let organisation = this.context.organisation;
        ...
        <li key={i} className={itemClass}>
       		<Grid container style={{ lineHeight: '0px' }} spacing={48}>
       			...
       			<Grid item xs={12} sm={7}>
       				<Button bsStyle="primary" onClick={() => this.handleSelectedItemClick(adapter,item, organisation)} style={buttonstyle}>Add adapter to komponent</Button>
       			</Grid>
       		</Grid>
       </li>
      )
