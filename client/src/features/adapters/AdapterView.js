...
import {deleteAdapterFromComponent, updateAdapter} from "../../data/redux/actions/adapters";
          ...
          <div>
            ...
            >
              ...
              <DialogActions>
                ...
                <Link to={{pathname: '/addAdapterToComponent', state: {adapter: this.props.location.state.adapter}}}
